...
#define ELEMENT_WIDTH (BOX_WIDTH + PADDING)
	...
	{
		//std::cout << "loop in print root print_bst.h:135 it = " << std::endl;
		//int d =  getNodeDepth(*this, root, treeIter.current_);
		//std::cout << "Key " << treeIter->first << " with depth: " << d << std::endl;
